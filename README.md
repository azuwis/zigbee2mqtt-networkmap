...
Download [`zigbee2mqtt-networkmap.js`](https://github.com/azuwis/zigbee2mqtt-networkmap/releases/download/v0.11.0/zigbee2mqtt-networkmap.js) and put it into `<config-directory>/www/` directory.
...
lovelace:
  mode: yaml
  resources:
    - url: /local/zigbee2mqtt-networkmap.js?v=0.11.0
      type: module
...
``` yaml
resources:
  - url: /local/zigbee2mqtt-networkmap.js?v=0.11.0 # change `v=x.x.x` to `v=0.11.0`
    type: module
```
